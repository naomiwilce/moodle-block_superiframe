...
$string['url_details'] = 'iFrame URL description';
$string['height'] = 'iFrame height';
$string['height_details'] = 'iFrame height description';
$string['width'] = 'iFrame width';
$string['width_details'] = 'iFrame width description';
$string['layout'] = 'iFrame layout';
$string['layout_details'] = 'iFrame layout description';